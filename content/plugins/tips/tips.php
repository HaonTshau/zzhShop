...
'emlog支持灵活的标签(tag)功能',
'在撰写产品的时候你可以使用Tab键方便的缩进内容',
'你可以为你的产品写一段漂亮的摘要，这样仅让摘要显示在首页并出现阅读全文链接',
'为防产品丢失，emlog会在你书写产品的时候为你自动保存它们',
'你可以在产品中插入flash格式的多媒体文件',
'不一样的心情，产品表情图标为您传达',
'你可以把你未写完的产品保存到草稿箱里，等下次有时间的时候再写',
'emlog会把太大的图片附件自动生产缩略图，从而加快页面加载速度',
'请关注后台首页的 官方信息 栏目，这里有最新的emlog动态',
'你可以把图片附件嵌入到内容中，让你的产品图文并茂',
'你可以在写产品的时候为产品设置访问密码，只让你授予密码的人访问',
'emlog支持多人联合撰写',
