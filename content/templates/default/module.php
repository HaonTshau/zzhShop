...
function order_module($ccolor,$csize,$ccount,$cname,$cphone,$caddress,$logid,$color,$size){
  ...
  <option value ="<?php echo $value;?>" selected="<?php if($value==$ccolor) echo 'selected';?>"><?php echo $value;?></option>
<?php endforeach;?>
</select>

<select name="sizelist">
	<?php
	foreach($sizelists as $b):?>	
  <option value ="<?php echo $b;?>" selected="<?php if($b==$csize) echo 'selected';?>"><?php echo $b;?></option>
<?php endforeach;?>
</select>
