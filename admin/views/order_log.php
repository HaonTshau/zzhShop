...
<div class="panel-heading">
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="order_log.php">订单管理</a></li>
<!--
        <li role="presentation" <?php if ($pid != 'draft'){echo 'class="active"';}?>><a href="order_log.php">订单管理</a></li>
